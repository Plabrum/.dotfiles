...
# CLI tools the stowed configs expect, from the native package manager rather
# than waiting on Homebrew. Excludes neovim (distro versions too old, see
# install_neovim_linux) and lazygit (no Debian package).
